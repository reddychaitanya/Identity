...
namespace SHIPOS.Identity.Web
{
    public class CustomViewService : IViewService
    {
        ...
        protected virtual Task<System.IO.Stream> Render(CommonViewModel model, string page, string clientName = null)
        {
            ...
            {
                siteName = System.Net.WebUtility.HtmlEncode(model.SiteName),
                model = System.Net.WebUtility.HtmlEncode(json),
        ...
        {
            var file = Path.Combine("C:\\code\\SHIPOS\\SHIPOS.Identity\\SHIPOS.Identity\\SHIPOS.Identity.Web\\", @"content\apps");
